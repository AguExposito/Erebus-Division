...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "Encounter".
    /// </summary>
    public struct EncounterActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Encounter/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_Encounter_Look;
        /// <summary>
        /// Provides access to the underlying input action "Encounter/Attack".
        /// </summary>
        public InputAction @Attack => m_Wrapper.m_Encounter_Attack;
        /// <summary>
        /// Provides access to the underlying input action "Encounter/Satchel".
        /// </summary>
        public InputAction @Satchel => m_Wrapper.m_Encounter_Satchel;
        /// <summary>
        /// Provides access to the underlying input action "Encounter/Dialogue".
        /// </summary>
        public InputAction @Dialogue => m_Wrapper.m_Encounter_Dialogue;
        /// <summary>
        /// Provides access to the underlying input action "Encounter/Flee".
        /// </summary>
        public InputAction @Flee => m_Wrapper.m_Encounter_Flee;
        /// <summary>
        /// Provides access to the underlying input action "Encounter/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_Encounter_Interact;
        /// <summary>
        /// Provides access to the underlying input action "Encounter/GoBack".
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="EncounterActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="EncounterActions.UnregisterCallbacks(IEncounterActions)" />.
        /// </summary>
        /// <seealso cref="EncounterActions.UnregisterCallbacks(IEncounterActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="EncounterActions.AddCallbacks(IEncounterActions)" />
        /// <seealso cref="EncounterActions.RemoveCallbacks(IEncounterActions)" />
        /// <seealso cref="EncounterActions.UnregisterCallbacks(IEncounterActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="EncounterActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Encounter" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="EncounterActions.AddCallbacks(IEncounterActions)" />
    /// <seealso cref="EncounterActions.RemoveCallbacks(IEncounterActions)" />
    public interface IEncounterActions
    {
        ...
        void OnAttack(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "Satchel" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
